...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::get('/profile/{user}', ['uses' => 'ProfileController@index', 'as' => 'profile', 'middleware' => 'auth']);
    ...
    Route::get('/friends', ['uses' => 'friendController@index', 'as' => 'friends']);
    Route::get('/friends/requests', ['uses' => 'FriendRequestController@index', 'as' => 'friends.requests']);
    Route::get('/friends/requests/new/{user}', ['uses' => 'FriendRequestController@store', 'as' => 'friends.requests.new']);
    Route::get('/friends/requests/delete/{friendrequest}', ['uses' => 'FriendRequestController@delete', 'as' => 'friends.requests.delete']);
    Route::get('/friends/requests/accept/{friendrequest}', ['uses' => 'FriendRequestController@accept', 'as' => 'friends.requests.accept']);
    Route::get('/notifications', ['uses' => 'NotificationController@index', 'as' => 'notifications']);
